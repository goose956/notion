...
const NICHE_SCREENSHOT_TABS: Record<string, string[]> = {
  "wedding-planner":        ["Dashboard", "Seating Planner", "Draft Letters", "Invitation Canvas", "AI Speech Writer", "Honeymoon Planner"],
  "rainbow":                ["Dashboard", "Seating Planner", "Draft Letters", "Invitation Canvas", "AI Speech Writer", "Honeymoon Planner"],
  ...
  "side-hustle":            ["Dashboard", "Plan Builder", "Financial Projector", "Market Analyser"],
  "neurodivergent-wedding": ["Dashboard", "What can I do?", "Vendor Brain Dump", "Break It Down", "Seating Planner", "Draft Letters", "AI Speech Writer", "Honeymoon Planner"],
  "food-business":          ["Dashboard", "Plan Builder", "Financial Projector", "Compliance"],
  "content-creator":        ["Dashboard", "Idea Generator", "Script Writer", "Caption Writer"],
  "etsy-shop":              ["Dashboard", "Listing Writer", "Finance Tracker", "Review Manager"],
  "cake-business":          ["Dashboard", "Plan Builder", "Pricing & Financials", "Compliance"],
  "str-guidebook":          ["Dashboard", "Guidebook", "Welcome Pack", "Guest Messages"],
  "nail-tech":              ["Dashboard", "Plan Builder", "Pricing & Financials", "Compliance"],
  "teacher":                ["Dashboard", "My Classes", "Lesson Planner", "Report Writer", "Assessments", "Tasks", "Key Dates", "My Documents"],
  "author":                 ["Dashboard", "Story Planner", "Character Builder", "Scene Writer", "Cover Studio", "My Library"],
  "freelancer":             ["Dashboard", "Proposal Writer", "Invoice Builder", "Outreach Writer", "My Documents"],
  "personal-trainer":       ["Dashboard", "Programme Builder", "Client Check-In", "Nutrition Guide", "My Documents"],
  "amazon-fba":             ["Dashboard", "Product Research", "Listing Writer", "Supplier Brief", "My Documents"],
  "podcast":                ["Dashboard", "Episode Planner", "Show Notes", "Guest Outreach", "Transcript Summary", "My Documents"],
  "vibe-coder":             ["Dashboard", "Idea Scorer", "Project Planner", "Launch Kit", "My Documents"],
  "keto":                   ["Dashboard", "Meal Planner", "Recipe Analyser", "Macro Calculator", "My Meals", "What Can I Make?"],
  "send-parent":            ["Dashboard", "Appointments", "Behaviour Log", "EHCP Builder", "Letter Writer", "Documents"],
};
        ...
        {loading ? (
          ...
          <>
            ...
            {NICHE_REGISTRY.map((entry) => {
              ...
              if (entry.nicheId === "str-guidebook") return (
                <STRGuidebookNicheShell
                  key="str-guidebook"
                  activeTab={activeTab}
                  databases={databases}
              ...
              if (entry.nicheId === "personal-trainer") return (
                <PTNicheShell
